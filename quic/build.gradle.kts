...
dependencies {
    ...
    for (classifier in listOf("linux-x86_64", "linux-aarch_64", "osx-x86_64", "osx-aarch_64", "windows-x86_64")) {
        "runtime"(variantOf(libs.netty.codec.native.quic) { classifier(classifier) })
    }
}
