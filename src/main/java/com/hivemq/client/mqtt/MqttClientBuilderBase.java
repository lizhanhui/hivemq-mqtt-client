...
public interface MqttClientBuilderBase<B extends MqttClientBuilderBase<B>> {
    ...
    /**
     * Sets the {@link MqttClientConfig#getQuicConfig() QUIC transport configuration} to the default configuration.
     *
     * @return the builder.
     * @since 1.5
     */
    ...
    /**
     * Sets the optional {@link MqttClientConfig#getQuicConfig() QUIC transport configuration}.
     *
